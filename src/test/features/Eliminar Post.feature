Feature: User Authentication tests
  ...
  Scenario: Post must be created
    ...
    And User fills the title as "test_6"
    And User fills the description as "test_6"
  ...
  Scenario: Post draft must be created
    ...
    And User click the login button 
    And User goes to create a new post
    And User fills the title as "test_7"
    And User fills the description as "test_7"
  ...
  Scenario: Post Schedule must be created
    ...
    And User click the login button 
    And User goes to create a new post
    And User fills the title as "test_8"
    And User fills the description as "test_8"
  ...
  Scenario: Post with Link must be created
    ...
    And User click the login button 
    And User goes to create a new post
    And User fills the title as "test_9"
    And User fills the description as "test_9"
  ...
  Scenario: Post with Link must be created and navigated
    ...
    And User click the login button 
    And User goes to create a new post
    And User fills the title as "test_10"
    And User fills the description as "test_10"
